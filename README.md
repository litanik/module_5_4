...
Разберёмся, как происходит передача данных между ними на следующем примере (https://drive.google.com/file/d/1TLwQ1CNALqd3KhJKPQRd6B84mkHX62Tk/view?usp=sharing)
...
Примечания:
Более подробно о работе метода __new__ можно узнать здесь (https://docs.python.org/3/reference/datamodel.html#object.__new__).
